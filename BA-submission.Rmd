...
footnotes:
  - ref: t1
    text: "Corresponding Author: dmytro.perepolkin@cec.lu.se"
MSC2020primary:
  - 62C10
  - 62F15
MSC2020secondary:
...
keywords:
  ...
  - indirect inference
supplements:
  - title: Stan and R code
    description: Target markdown [@landau2021TargetsPackageDynamic] with corresponding targets defined in R and Stan for executing all examples in the paper.
  - title: Moebius strip of probability functions
    description: DIY souvenir illustrating the relationship between the probability functions.
...
date: "`r Sys.Date()`"
bibliography: "`r rbbt::bbt_write_bib('BA-submission.bib', translator='bibtex', overwrite = TRUE)`"
#linenumbers: true
#numbersections: true
csl: imsart.csl
output: 
  bookdown::pdf_book: 
    ...
    keep_tex: true # you need it to submit to the journal
---
...
rsvg::rsvg_png("img/QDs.svg", "img/QDs.png", width=1200*0.8, height = 800*0.8)
...
```{r chebyshev-roots-gnk-graph, fig.width=14, fig.height=5, out.width='100%',fig.align='center', echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Chebyshev polynomial approximation: valid QDF and true-positive proxy roots"}
ps_grd <- seq(0,1,1e-3)
...
```{r chebyshev-roots-gnh-graph, fig.width=14, fig.height=5, out.width='100%', fig.align='center', echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Chebyshev polynomial approximation: valid QDF and false-positive proxy roots"}
